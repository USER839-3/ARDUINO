...
#define REGION_NAME "SAN CRISTÓBAL"
#define REGION_ALTITUDE 1912.0          // Altitud en metros sobre el nivel del mar
#define REGION_LATITUDE 20.59598        // Latitud (opcional, para cálculos UV)
#define REGION_LONGITUDE -99.00031      // Longitud (opcional)

// Temperaturas características de tu región
#define TEMP_MIN_ANNUAL 5.0             // Mínima anual típica (°C)
#define TEMP_MAX_ANNUAL 30.0            // Máxima anual típica (°C)
#define TEMP_AVG_COLD_MONTH 12.2        // Promedio mes más frío (°C)
#define TEMP_AVG_HOT_MONTH 17.0         // Promedio mes más caluroso (°C)

// Humedad típica de tu región
#define HUMIDITY_MIN_TYPICAL 48.0       // Mínima típica (%)
#define HUMIDITY_MAX_TYPICAL 75.0       // Máxima típica (%)
#define HUMIDITY_AVG_DRY_SEASON 48.0    // Promedio temporada seca (%)
#define HUMIDITY_AVG_WET_SEASON 75.0    // Promedio temporada lluviosa (%)

// Presión atmosférica base (calculada automáticamente)
#define SEA_LEVEL_PRESSURE 1013.25
#define REGION_PRESSURE_BASE 823.45     // Precalculada para 1912m

// Patrones de lluvia regionales
#define RAINY_SEASON_START 6            // Mes de inicio (junio)
#define RAINY_SEASON_END 10             // Mes de fin (octubre)
...
#define WIND_SPEED_MIN 9.7              // km/h
#define WIND_SPEED_MAX 12.9             // km/h
#define WIND_SPEED_AVG 11.5             // km/h
...
#define UV_CALIBRATION_FACTOR 11        // Factor de calibración UV (entero)
...
// Validación solo con números enteros (sin decimales)
...
#if AI_HISTORY_SIZE < 6 || AI_HISTORY_SIZE > 24
#error "Tamaño de histórico debe ser entre 6 y 24 horas"
#endif

// Nota: Las validaciones de números decimales se realizan en tiempo de ejecución
// en lugar del preprocessor para evitar errores de compilación
